-- Sample PostGres script to UPDATE an existing app_config value in the database
-- To see all rows having a string as part of their name, use:  appconfig-query.sql

\echo
\echo == Edit a copy of this script to update an existing appconfig row
\echo ==   Note2: yourUserId is your numeric user_principal.user_principal_id, not your user name
