create table appt_visit(
    appt_visit_id numeric(19) not null,
    visit_type varchar2(50) not null,
    visit_description varchar2(500) not null,
    visit_eid numeric(19) not null,
...
create sequence appt_visit_seq minvalue 1 maxvalue 999999999999999999
