-- Sample Oracle script to UPDATE an existing app_config value in the database
-- To see all rows having a string as part of their name, use:  appconfig-query.sql

prompt
prompt == Edit a copy of this script to update an existing appconfig row
