...
--
ALTER TABLE APP_CONFIG ADD (CONFIG_TYPE VARCHAR2(255));
...
ALTER TABLE APP_CONFIG_CHANGE_HISTORY ADD (CONFIG_TYPE VARCHAR2(255));
...
--
-- Change the value column to be a clob to accommodate much larger values and allow nulls
--
ALTER TABLE APP_CONFIG ADD (CONFIG_VALUE_CLOB CLOB);
...
ALTER TABLE APP_CONFIG MODIFY CONFIG_TYPE VARCHAR2(255) NOT NULL;
ALTER TABLE APP_CONFIG DROP CONSTRAINT APP_CONFIG_SITE_FK;
ALTER TABLE APP_CONFIG MODIFY (CONFIG_VALUE NULL);

ALTER TABLE APP_CONFIG_CHANGE_HISTORY ADD (CONFIG_VALUE_CLOB CLOB);
...
ALTER TABLE APP_CONFIG_CHANGE_HISTORY MODIFY CONFIG_TYPE VARCHAR2(255) NOT NULL;
