...
/**
 *  Copy of JQMCheckset. @author Stephen K Samuel samspade79@gmail.com 24 May 2011
 *  Created 03/2018 by tpacht to add support for HTML tags in the legend
 */
public class CustomJQMCheckset extends JQMFieldContainer implements HasText<CustomJQMCheckset>,
    HasSelectionHandlers<String>, HasOrientation<CustomJQMCheckset>, HasMini<CustomJQMCheckset>,
  ...
  /**
   * Creates a new {@link CustomJQMCheckset} with no label text
   */
  public CustomJQMCheckset() {
    this((String)null);
  }

  /**
   * Creates a new {@link CustomJQMCheckset} with the label set to the given text.
   *
   * @param text
   *              the display text for the label
   */
  public CustomJQMCheckset(String text) {
    setupFieldset(text);
  }

  public CustomJQMCheckset(SafeHtml html) {
    setupFieldset(null);
  ...
  @Override
  public CustomJQMCheckset withHorizontal() {
    setHorizontal();
    return this;
  }
  ...
  @Override
  public CustomJQMCheckset withText(String text) {
    setText(text);
    return this;
  }
  ...
  @Override
  public CustomJQMCheckset withVertical() {
    setVertical();
    return this;
  }
   ...
   */
  @Override
  public CustomJQMCheckset withMini(boolean mini) {
    setMini(mini);
    return this;
  }
}
