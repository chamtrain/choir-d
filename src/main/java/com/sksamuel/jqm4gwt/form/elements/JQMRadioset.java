...
/**
 *  Copy of JQMRadioset. @author Stephen K Samuel samspade79@gmail.com 24 May 2011
 *  Created 03/2018 by tpacht to  support radio choices with HTML tags in their label
 *
 */
public class JQMRadioset extends JQMFieldContainer implements HasText<JQMRadioset>, HasValue<String>,
  ...
  public JQMRadioset(SafeHtml html) {
    setupFieldset(null);
    if (html != null) {
  ...
  public JQMRadio addRadio(String value, SafeHtml html) {
    JQMRadio radio = new JQMRadio();
