...
/**
 * Item bank for PROMIS assessment. Generated from OID 3F539F64-FEF9-4F0B-9EB3-8C18641053DD.
 */
public class PromisBankOneZeroSmokingPsychSocExpectDaily {
  private static final ItemBank bank = itemBank(0.0, 0.0, 4, 12, 3.0,
      ...
      item("SMKPSY15", "", "Smoking leaves an unpleasant odor on my clothes.", "", 1.35, new double[] { -2.48, -0.91, 0.12, 0.99 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKPSY16", "", "I'm foolish to ignore the warnings about cigarettes.", "", 1.67, new double[] { -1.71, -0.93, -0.09, 0.58 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKPSY17", "", "I smoke too much.", "", 1.5, new double[] { -1.83, -0.74, 0.17, 0.86 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKPSY18", "", "I hide my smoking from other people.", "", 1.05, new double[] { 0.66, 1.62, 2.57, 3.48 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKPSY19", "", "I feel uncomfortable smoking around kids.", "", 0.97, new double[] { -2.53, -1.37, -0.39, 0.63 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKPSY20", "", "Most of the people I care about want me to quit smoking.", "", 1.72, new double[] { -1.82, -0.73, 0.07, 0.77 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
