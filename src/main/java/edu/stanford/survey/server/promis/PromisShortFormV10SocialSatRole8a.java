...
/**
 * Item bank for PROMIS assessment. Generated from OID CA9FB9D0-B5A7-478D-8D6B-A364EA9F1778.
 */
public class PromisShortFormV10SocialSatRole8a {
  private static final ItemBank bank = itemBank(0.0, 0.0, 8, 8, 3.0,
      ...
      item("SRPSAT38", "In the past 7 days", "I am satisfied with the amount of time I spend performing my daily routines", "", 3.731, new double[] { -1.512, -0.848, 0.008, 0.766 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
