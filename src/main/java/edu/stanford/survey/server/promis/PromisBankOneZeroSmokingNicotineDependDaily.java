...
/**
 * Item bank for PROMIS assessment. Generated from OID AD479201-5F9A-49BD-8667-EC551A5D8FA9.
 */
public class PromisBankOneZeroSmokingNicotineDependDaily {
  private static final ItemBank bank = itemBank(0.0, 0.0, 4, 12, 3.0,
      ...
      item("SMKNDEP20", "", "It is hard for me to go without smoking for a whole day.", "", 2.41, new double[] { -2.0, -1.21, -0.63, 0.02 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKNDEP21", "", "Smoking is a large part of my daily life.", "", 1.52, new double[] { -2.19, -1.04, -0.06, 0.9 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKNDEP23", "", "I smoke when I am alone.", "", 0.81, new double[] { -6.63, -5.01, -2.02, 0.62 }, -1, "",
          response("Never", 1),
          response("Rarely", 2),
          response("Sometimes", 3),
          response("Often", 4),
      ...
      item("SMKNDEP24", "", "The thought of never smoking again is overwhelming.", "", 1.56, new double[] { -0.97, -0.08, 0.74, 1.44 }, -1, "",
          response("Not at all", 1),
          response("A little bit", 2),
          response("Somewhat", 3),
          response("Quite a bit", 4),
      ...
      item("SMKNDEP25", "", "I am tempted to smoke when I am happy.", "", 0.98, new double[] { -4.02, -2.14, 0.68, 2.43 }, -1, "",
          response("Never", 1),
          response("Rarely", 2),
          response("Sometimes", 3),
          response("Often", 4),
      ...
      item("SMKNDEP26", "", "I am tempted to smoke when I am driving.", "", 0.74, new double[] { -3.37, -2.48, -1.08, 0.81 }, -1, "",
          response("Never", 1),
          response("Rarely", 2),
          response("Sometimes", 3),
          response("Often", 4),
      ...
      item("SMKNDEP27", "", "After eating I want a cigarette.", "", 1.21, new double[] { -4.14, -3.04, -1.49, -0.12 }, -1, "",
          response("Never", 1),
          response("Rarely", 2),
          response("Sometimes", 3),
          response("Often", 4),
