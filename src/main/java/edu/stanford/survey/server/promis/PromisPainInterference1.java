...
/**
 * Item bank for PROMIS generated from: PainInterference v1.1 154D0273-C3F6-4BCE-8885-3194D4CC4596.json
 */
public class PromisPainInterference1 {
  ...
  item("PAININ19", "In the past 7 days", "How much did pain make it difficult to fall asleep?", "", 2.83373, new double[] { 0.2328, 0.954, 1.4495, 2.0753 }, -1, "", 
    response("Not at all", 1),
    response("A little bit", 2),
    response("Somewhat", 3),
    response("Quite a bit", 4),
  ...
  item("PAININ38", "In the past 7 days", "How often did you avoid social activities because it might make you hurt more?", "", 4.5601, new double[] { 0.563, 0.9911, 1.5776, 2.3206 }, -1, "", 
    response("Never", 1),
    response("Rarely", 2),
    response("Sometimes", 3),
    response("Often", 4),
  ...
  item("PAININ40", "In the past 7 days", "How often did pain prevent you from walking more than 1 mile?", "", 2.98284, new double[] { 0.369, 0.7379, 1.1128, 1.5541 }, -1, "", 
    response("Never", 1),
    response("Rarely", 2),
    response("Sometimes", 3),
    response("Often", 4),
  ...
  item("PAININ42", "In the past 7 days", "How often did pain prevent you from standing for more than one hour?", "", 2.74006, new double[] { 0.402, 0.8057, 1.2324, 1.7405 }, -1, "", 
    response("Never", 1),
    response("Rarely", 2),
    response("Sometimes", 3),
    response("Often", 4),
  ...
  item("PAININ47", "In the past 7 days", "How often did pain prevent you from standing for more than 30 minutes?", "", 2.74829, new double[] { 0.3449, 0.823, 1.3601, 1.9293 }, -1, "", 
    response("Never", 1),
    response("Rarely", 2),
    response("Sometimes", 3),
    response("Often", 4),
  ...
  item("PAININ50", "In the past 7 days", "How often did pain prevent you from sitting for more than 30 minutes?", "", 2.82948, new double[] { 0.7303, 1.2605, 1.8401, 2.5902 }, -1, "", 
    response("Never", 1),
    response("Rarely", 2),
    response("Sometimes", 3),
    response("Often", 4),
  ...
  item("PAININ54", "In the past 7 days", "How often did pain keep you from getting into a standing position?", "", 2.20125, new double[] { 1.1017, 1.5676, 1.9664, 2.293 }, -1, "", 
    response("Never", 1),
    response("Once a week or less", 2),
    response("Once every few days", 3),
    response("Once a day", 4),
    response("Every few hours", 5)
  ),
  item("PAININ55", "In the past 7 days", "How often did pain prevent you from sitting for more than one hour?", "", 2.68327, new double[] { 0.7217, 1.2032, 1.7465, 2.4084 }, -1, "", 
    response("Never", 1),
    response("Rarely", 2),
    response("Sometimes", 3),
    response("Often", 4),
