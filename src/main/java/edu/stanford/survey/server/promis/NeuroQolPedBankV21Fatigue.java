...
/**
 * Item bank for PROMIS assessment. Generated from OID C81F128D-F091-4AF5-917A-060FAC6B21B5.
 */
public class NeuroQolPedBankV21Fatigue {
  private static final ItemBank bank = itemBank(0.0, 0.0, 4, 11, 3.0,
      ...
      item("NQFTGpeds07", "In the past 7 days", "I got upset by being too tired to do things I wanted to do", "", 3.54, new double[] { -0.01, 0.71, 1.4, 2.08 }, -1, "",
          response("none of the time", 1),
          response("a little bit of time", 2),
          response("some of the time", 3),
          response("most of the time", 4),
      ...
      item("NQFTGpeds09", "In the past 7 days", "I needed help doing my usual things at home", "", 2.51, new double[] { 0.05, 0.92, 1.79, 2.73 }, -1, "",
          response("none of the time", 1),
          response("a little bit of time", 2),
          response("some of the time", 3),
          response("most of the time", 4),
      ...
      item("NQFTGpeds10", "In the past 7 days", "I felt weak", "", 3.73, new double[] { 0.26, 0.94, 1.63, 1.99 }, -1, "",
          response("none of the time", 1),
          response("a little bit of time", 2),
          response("some of the time", 3),
          response("most of the time", 4),
