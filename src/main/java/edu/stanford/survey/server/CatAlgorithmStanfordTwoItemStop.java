 ...
 * version is intended to combine the features of {@link edu.stanford.survey.server.CatAlgorithmStanford}
 * and {@link edu.stanford.survey.server.CatAlgorithmPromisTwoItemStop}.
 */
public class CatAlgorithmStanfordTwoItemStop implements CatAlgorithm2 {
  private static final Logger log = Logger.getLogger(CatAlgorithmStanfordTwoItemStop.class);
  ...
  public Item nextItem(List<Response> currentAssessmentResponses, List<Item> currentIgnored) {
    if (currentAssessmentResponses != null && currentAssessmentResponses.size() == 2) {
      // TODO: this isn't really correct (see CatAlgorithmPromisTwoItemStop for details) but works for testing Anger
