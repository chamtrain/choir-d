...
public class CustomRadioButton extends RadioButton implements FormCustomDataIntf, SurveyFormDataIntf {

  public CustomRadioButton(String name) {
    super(name);
  }

  public CustomRadioButton(String name, String label) {
    super(name, label);
  }
  ...
  public void setCustomData(FormData data) {
    myExtraData = data;
  }
