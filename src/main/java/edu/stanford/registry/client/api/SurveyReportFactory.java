 ...
 */
public interface SurveyReportFactory extends ApiObjectFactory {
  /**
   * Bump this when making changes client and server need to agree on.
   */
  long compatibilityLevel = 1;

  AutoBean<SurveyReport> surveyReport();

  AutoBean<SurveyReportStudy> surveyReportStudy();

  AutoBean<SurveyReportQuestion> SurveyReportQuestion();
