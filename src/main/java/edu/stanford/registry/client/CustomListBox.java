...
public class CustomListBox extends ListBox implements FormCustomDataIntf, SurveyFormDataIntf {

  private FormData myExtraData = new FormData();
  SurveyFormData surveyFormData = null;
  ...
  public boolean hasFormData() {
    return surveyFormData != null;
  }

  @Override
  public void reset() {
    for (int s = 0; s < this.getItemCount(); s++) {
