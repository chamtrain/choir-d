...
public interface PatientIdService extends RemoteService {
  Patient getPatient(String patientId) throws ServiceUnavailableException, InvalidPatientIdException;
