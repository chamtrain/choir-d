...
public class OrthoHandPatientProfile extends edu.stanford.registry.server.imports.data.PatientProfile
   ...
   * @throws Exception when data elements are missing or invalid
   */
  @Override
  ...
  public String getDataSource() {
    return "OrthoHandPatientProfile";
  }
