...
public class PedPainHl7Customizer extends Hl7Customizer implements Hl7CustomizerIntf {
  private final SiteInfo siteInfo;

  PedPainHl7Customizer(SiteInfo siteInfo) {
    super(siteInfo);
  ...
  public Hl7AppointmentIntf getHl7Appointment(Database database) {
    return new PedPainHl7Appointment(database, siteInfo);
  }
}
