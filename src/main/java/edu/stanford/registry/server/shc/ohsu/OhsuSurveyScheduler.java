...
public class OhsuSurveyScheduler {
  private static final Logger logger = Logger.getLogger(OhsuSurveyScheduler.class);
  protected final Database database;
  protected final Long siteId;
  protected final SiteInfo siteInfo;

  public OhsuSurveyScheduler(Database database, SiteInfo siteInfo) {
    ...
    try {
      ...
      String sql =
          "SELECT distinct sr.patient_id from appt_registration sr, patient_attribute pa1, patient_attribute pa2 " // , survey_token st
              ...
              + "and pa2.patient_id = sr.patient_id and pa2.survey_site_id = sr.survey_site_id and pa2.data_name='research' and pa2.data_value='y' "
              + " and not exists "
      ...
      List<String> patientIds = database.toSelect(sql)
          .argLong(":site", siteId)
