...
public class PainHl7Customizer extends Hl7Customizer implements Hl7CustomizerIntf {
  private final SiteInfo siteInfo;

  public PainHl7Customizer(SiteInfo siteInfo) {
    super(siteInfo);
    this.siteInfo = siteInfo;
  }

  public Hl7AppointmentIntf getHl7Appointment(Database database) {
    return new PainHl7Appointment(database, siteInfo);
  }
